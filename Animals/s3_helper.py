...
class S3Helper:
    ...
    Partitions data by date: animals/year=YYYY/month=MM/day=DD/
    """
    ...
    def get_partition_prefix(self, target_date: datetime = None) -> str:
        ...
        Format: animals/year=YYYY/month=MM/day=DD/
        ...
        return f"4sale-data/animals/year={year}/month={month}/day={day}"
