...
class ServicesJsonScraper:
    """
    Scrapes Q84Sale services using JSON data from __NEXT_DATA__ script tag
    This approach is fast and reliable as it doesn't depend on dynamic CSS classes
    """
    
    def __init__(self):
        self.base_url = "https://www.q84sale.com/ar/services"
    ...
    async def get_subcategories(self) -> List[Dict]:
        """
        Get all service subcategories from the main services page
