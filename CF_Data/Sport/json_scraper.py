...
class SportJsonScraper:
    """
    Scrapes Q84Sale sport listings using JSON data from __NEXT_DATA__ script tag
    ...
    def __init__(self):
        self.base_url = "https://www.q84sale.com/ar/sport"
    ...
    async def get_subcategories(self) -> List[Dict]:
        """
        Get all subcategories from the sport main page
        ...
        try:
            ...
            if not vertical_subcats:
                logger.warning("No verticalSubcats found in sport page")
                return []
    ...
    async def get_listings(self, subcategory_slug: str, page_num: int = 1, 
        ...
        """
        Get all listings for a specific sport subcategory
        ...
        """
        try:
            # Build URL using the sport parent slug
