...
class R2Helper:
    ...
    Partitions data by date: sport/year=YYYY/month=MM/day=DD/
    """
    ...
    def get_partition_prefix(self, target_date: datetime = None) -> str:
        ...
        Format: 4sale-data/sport/year=YYYY/month=MM/day=DD/
        ...
        return f"4sale-data/sport/year={year}/month={month}/day={day}"
