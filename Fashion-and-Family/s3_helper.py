...
class S3Helper:
    ...
    Partitions data by date: fashion-and-family/year=YYYY/month=MM/day=DD/
    """
    ...
    def get_partition_prefix(self, target_date: datetime = None) -> str:
        ...
        Format: 4sale-data/fashion-and-family/year=YYYY/month=MM/day=DD/
        ...
        return f"4sale-data/fashion-and-family/year={year}/month={month}/day={day}"
