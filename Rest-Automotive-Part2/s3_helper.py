...
class S3Helper:
    ...
    Partitions data by date: rest-automotive-part2/year=YYYY/month=MM/day=DD/
    """
    ...
    def get_partition_prefix(self, target_date: datetime = None) -> str:
        ...
        Format: 4sale-data/rest-automotive-part2/year=YYYY/month=MM/day=DD/
        ...
        return f"4sale-data/rest-automotive-part2/year={year}/month={month}/day={day}"
