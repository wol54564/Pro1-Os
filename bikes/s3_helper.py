...
class S3Helper:
    ...
    Partitions data by date: bikes/year=YYYY/month=MM/day=DD/
    """
    ...
    def get_partition_prefix(self, target_date: datetime = None) -> str:
        ...
        Format: 4sale-data/bikes/year=YYYY/month=MM/day=DD/
        ...
        return f"4sale-data/bikes/year={year}/month={month}/day={day}"
    ...
    def upload_image(self, image_url: str, image_data: bytes, subcategory_slug: str,
                     ...
                     image_index: int = 0, main_subcategory: Optional[str] = None) -> Optional[str]:
        """
        ...
        Args:
            ...
            main_subcategory: Main subcategory folder (e.g., 'motorbikes-sport', 'bicycles')
        ...
        try:
            ...
            partition = self.get_partition_prefix(target_date)
            # Include main subcategory in path if provided
            if main_subcategory:
                s3_key = f"{partition}/images/{main_subcategory}/{subcategory_slug}/{filename}"
            else:
