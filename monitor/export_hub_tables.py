...
HUB_DAILY_COLS = [
    ...
    "total_unique_phones",
    "total_valid_phones",
    "total_invalid_phones",
    "total_outside_country_phones",
    "total_r2_files",
    "total_r2_size_bytes",
    "total_r2_daily_size",
    "total_r2_images_bytes",
    "total_r2_json_bytes",
    "total_r2_excel_bytes",
    "total_r2_csv_bytes",
    "total_r2_parquet_bytes",
    "total_r2_other_bytes",
    "total_r2_daily_images_bytes",
    "total_r2_daily_json_bytes",
    "total_r2_daily_excel_bytes",
    "total_r2_daily_csv_bytes",
    "total_r2_daily_parquet_bytes",
    "total_r2_daily_other_bytes",
    "total_requests",
...
SITE_DAILY_COLS = [
    ...
    "r2_parquet_bytes",
    "r2_other_bytes",
    "r2_daily_images_bytes",
    "r2_daily_json_bytes",
    "r2_daily_excel_bytes",
    "r2_daily_csv_bytes",
    "r2_daily_parquet_bytes",
    "r2_daily_other_bytes",
    "requests_total",
    "requests_failed",
    "error_rate_pct",
    "requests_per_min",
...
def _duration_from_github_run(github_run: Dict) -> Optional[int]:
    ...
    Ignore Schema Monitor duration.
    Sum multiple scraper workflows.
    """

    workflows = github_run.get("workflows") or []

    # First: calculate from scraper workflows only
    if workflows:
        total = 0
        found = False
        ...
        for workflow in workflows:
            ...
            if is_monitor_workflow(name):
                continue

            duration = workflow.get("duration_sec")
            ...
            started = workflow.get("run_started_at") or workflow.get("started_at")
            finished = workflow.get("updated_at") or workflow.get("finished_at")
            ...
            if started and finished:
                try:
                    ...
                    total += max(
                        0,
                        int((finish_dt - start_dt).total_seconds())
                    )
                    found = True
    ...
    # Do not use Schema Monitor duration
    if is_monitor_workflow(github_run.get("workflow_name")):
        return None
...
def flatten_hub(
    ...
    hub_row = {
        ...
        "total_valid_phones": merged.get("total_valid_phones"),
        "total_invalid_phones": merged.get("total_invalid_phones"),
        "total_outside_country_phones": merged.get("total_outside_country_phones"),
        "total_r2_files": merged.get("total_r2_files"),
        "total_r2_size_bytes": merged.get("total_r2_size_bytes"),
        "total_r2_daily_size": merged.get("total_r2_daily_size"),
        "total_r2_images_bytes": merged.get("total_r2_images_bytes"),
        "total_r2_json_bytes": merged.get("total_r2_json_bytes"),
        "total_r2_excel_bytes": merged.get("total_r2_excel_bytes"),
        "total_r2_csv_bytes": merged.get("total_r2_csv_bytes"),
        "total_r2_parquet_bytes": merged.get("total_r2_parquet_bytes"),
        "total_r2_other_bytes": merged.get("total_r2_other_bytes"),
        "total_r2_daily_images_bytes": merged.get("total_r2_daily_images_bytes"),
        "total_r2_daily_json_bytes": merged.get("total_r2_daily_json_bytes"),
        "total_r2_daily_excel_bytes": merged.get("total_r2_daily_excel_bytes"),
        "total_r2_daily_csv_bytes": merged.get("total_r2_daily_csv_bytes"),
        "total_r2_daily_parquet_bytes": merged.get("total_r2_daily_parquet_bytes"),
        "total_r2_daily_other_bytes": merged.get("total_r2_daily_other_bytes"),
    ...
    for site in merged.get("sites", []):
        ...
        site_rows.append({
            ...
            "valid_phones": site.get("valid_phones"),
            "invalid_phones": site.get("invalid_phones"),
            "outside_country_phones": site.get("outside_country_phones"),
            "r2_file_count": site.get("r2_file_count"),
            "r2_size_bytes": site.get("r2_size_bytes"),
            "r2_daily_size": site.get("r2_daily_size"),
                "r2_images_bytes": site.get("r2_images_bytes"),
                "r2_json_bytes": site.get("r2_json_bytes"),
                "r2_excel_bytes": site.get("r2_excel_bytes"),
                "r2_csv_bytes": site.get("r2_csv_bytes"),
                "r2_parquet_bytes": site.get("r2_parquet_bytes"),
                "r2_other_bytes": site.get("r2_other_bytes"),
                "r2_daily_images_bytes": site.get("r2_daily_images_bytes"),
                "r2_daily_json_bytes": site.get("r2_daily_json_bytes"),
                "r2_daily_excel_bytes": site.get("r2_daily_excel_bytes"),
                "r2_daily_csv_bytes": site.get("r2_daily_csv_bytes"),
                "r2_daily_parquet_bytes": site.get("r2_daily_parquet_bytes"),
                "r2_daily_other_bytes": site.get("r2_daily_other_bytes"),
        ...
        for scraper_name, sr in _scraper_entries(report):
            ...
            scraper_rows.append({
                ...
                "valid_phones": sr.get("valid_phones"),
                "invalid_phones": sr.get("invalid_phones"),
                "outside_country_phones": sr.get("outside_country_phones"),
                "total_rows": sr.get("total_rows"),
                "ads_source": sr.get("ads_source"),
                "r2_file_count": sr.get("r2_file_count"),
                "r2_size_bytes": sr.get("r2_size_bytes"),
                "r2_daily_size": sr.get("r2_daily_size"),
                "r2_images_bytes": sr.get("r2_images_bytes"),
                "r2_json_bytes": sr.get("r2_json_bytes"),
                "r2_excel_bytes": sr.get("r2_excel_bytes"),
                "r2_csv_bytes": sr.get("r2_csv_bytes"),
                "r2_parquet_bytes": sr.get("r2_parquet_bytes"),
                "r2_other_bytes": sr.get("r2_other_bytes"),
                "r2_daily_images_bytes": sr.get("r2_daily_images_bytes"),
                "r2_daily_json_bytes": sr.get("r2_daily_json_bytes"),
                "r2_daily_excel_bytes": sr.get("r2_daily_excel_bytes"),
                "r2_daily_csv_bytes": sr.get("r2_daily_csv_bytes"),
                "r2_daily_parquet_bytes": sr.get("r2_daily_parquet_bytes"),
                "r2_daily_other_bytes": sr.get("r2_daily_other_bytes"),
