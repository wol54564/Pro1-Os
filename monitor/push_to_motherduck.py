...
TABLE_COLUMNS: Dict[str, List[str]] = {
    ...
    "scraper_hourly_daily": SCRAPER_HOURLY_DAILY_COLS,
...
SCHEMA_STATEMENTS = [
    ...
    total_unique_phones  INTEGER,
      ...
      total_invalid_phones INTEGER,
      total_outside_country_phones INTEGER,
      total_r2_files       INTEGER,
      total_r2_size_bytes  BIGINT,
      total_r2_daily_size  BIGINT,
      total_r2_images_bytes BIGINT,
      total_r2_json_bytes BIGINT,
      total_r2_excel_bytes BIGINT,
      total_r2_csv_bytes BIGINT,
      total_r2_parquet_bytes BIGINT,
      total_r2_other_bytes BIGINT,
      total_r2_daily_images_bytes BIGINT,
      total_r2_daily_json_bytes BIGINT,
      total_r2_daily_excel_bytes BIGINT,
      total_r2_daily_csv_bytes BIGINT,
      total_r2_daily_parquet_bytes BIGINT,
      total_r2_daily_other_bytes BIGINT,
      total_requests       INTEGER,
      total_requests_failed INTEGER,
      avg_error_rate_pct   DOUBLE,
      avg_requests_per_min DOUBLE,
      hub_prefix           VARCHAR,
    ...
    unique_phones        INTEGER,
      valid_phones         INTEGER,
      invalid_phones       INTEGER,
      outside_country_phones INTEGER,
      r2_file_count        INTEGER,
      r2_size_bytes        BIGINT,
      r2_daily_size        BIGINT,
      r2_images_bytes      BIGINT,
      r2_json_bytes        BIGINT,
      r2_excel_bytes       BIGINT,
      r2_csv_bytes         BIGINT,
      r2_parquet_bytes     BIGINT,
      r2_other_bytes       BIGINT,
      r2_daily_images_bytes BIGINT,
      r2_daily_json_bytes  BIGINT,
      r2_daily_excel_bytes BIGINT,
      r2_daily_csv_bytes   BIGINT,
      r2_daily_parquet_bytes BIGINT,
      r2_daily_other_bytes BIGINT,
      requests_total       INTEGER,
      requests_failed      INTEGER,
      error_rate_pct       DOUBLE,
      requests_per_min     DOUBLE,
      scrapers_failed      INTEGER,
      run_date             DATE,
      inspect_date         DATE,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS scraper_hourly_daily (
      hub_partition_date   DATE NOT NULL,
      site_id              VARCHAR NOT NULL,
      scraper              VARCHAR NOT NULL,
      hour                 INTEGER,
      ads_count            INTEGER,
      PRIMARY KEY (hub_partition_date, site_id, scraper, hour)
    )
    """,
    """
...
MIGRATION_STATEMENTS = [
    ...
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_unique_phones INTEGER",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_valid_phones INTEGER",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_invalid_phones INTEGER",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_outside_country_phones INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS unique_ads INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS unique_phones INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS valid_phones INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS invalid_phones INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS outside_country_phones INTEGER",
    ...
    "ALTER TABLE scraper_hourly_daily ADD COLUMN IF NOT EXISTS hour INTEGER",
    "ALTER TABLE scraper_hourly_daily ADD COLUMN IF NOT EXISTS ads_count INTEGER",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_files INTEGER",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_size_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_daily_size BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_file_count INTEGER",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_size_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_daily_size BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS unique_phones INTEGER",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS valid_phones INTEGER",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS invalid_phones INTEGER",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS outside_country_phones INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_file_count INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_size_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_daily_size BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_requests INTEGER",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_requests_failed INTEGER",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS avg_error_rate_pct DOUBLE",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS avg_requests_per_min DOUBLE",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS requests_total INTEGER",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS requests_failed INTEGER",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS error_rate_pct DOUBLE",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS requests_per_min DOUBLE",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS scrapers_failed INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS requests_total INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS requests_failed INTEGER",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS error_rate_pct DOUBLE",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS requests_per_min DOUBLE",
    ...
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_images_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_json_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_excel_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_csv_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_parquet_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_other_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_daily_images_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_daily_json_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_daily_excel_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_daily_csv_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_daily_parquet_bytes BIGINT",
    "ALTER TABLE hub_daily ADD COLUMN IF NOT EXISTS total_r2_daily_other_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_images_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_json_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_excel_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_csv_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_parquet_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_other_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_daily_images_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_daily_json_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_daily_excel_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_daily_csv_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_daily_parquet_bytes BIGINT",
    "ALTER TABLE site_daily ADD COLUMN IF NOT EXISTS r2_daily_other_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_images_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_json_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_excel_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_csv_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_parquet_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_other_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_daily_images_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_daily_json_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_daily_excel_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_daily_csv_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_daily_parquet_bytes BIGINT",
    "ALTER TABLE scraper_daily ADD COLUMN IF NOT EXISTS r2_daily_other_bytes BIGINT",
]
